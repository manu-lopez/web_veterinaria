...
<body>
    ...
    <div class="body-contacto body-contacto">
        ...
        <div class="container-fluid">
            ...
            <h2 class="text-white" style="text-align:center">Pedir cita Guardería</h2>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 ">
                                            ...
                                            <div class="form-group">
                                                <h4>Fecha desde</h4>
                                                <input type="date" class="form-control" id="fechadesde" name="fechadesde" placeholder="Fecha desde">
                                            </div>
                                        </div>
                                        <div class="col-md-6 ">
                                            <div class="form-group">
