...
<body>
  <?php include 'component/navbar.php'; ?>
    <header class="body-inicio">
      <div class="overlay"></div>
      <video width="1280" height="720" id="videoNosotros" playsinline autoplay muted loop>
        <source src="media/tour.mov" type="video/mp4">
        <track label="Español" kind="subtitles" src="media/subs-es.vtt" srclang="es">
      </video>
